...
function Moedas(){
    ...
    useEffect(() => {
        fetch('http://api.exchangeratesapi.io/v1/latest?access_key=aee58fa5346bfeb20a5124bc2d284918&format=1')
    ...
    const converterMoeda = () => {
        fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=aee58fa5346bfeb20a5124bc2d284918&format=1base=${deMoeda}&symbols=${paraMoeda}`)
        .then(response => response.json())
        .then(data => {
